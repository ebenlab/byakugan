...
| `internal/markdown` | Renders `.md` into the doc.css skeleton (goldmark, GFM). Hard boundary: no config, templates, highlighting, TOC, or taxonomies — never grow this toward a static site generator |
