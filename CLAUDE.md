...
| `internal/scanrules` | Shared scan contract: dir skip rules, BYAKUGAN_MAX_DEPTH nesting limit, path→project mapping — the single source for indexer and watcher |
